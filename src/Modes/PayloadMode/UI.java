...
public class UI {
    ...
    private void paintHealthBar(Graphics2D g2d) {
        ...
        g2d.fillRect(533, 668, 300, 30);
        g2d.setColor(new Color(127, 255, 0));
        g2d.fillRect(533, 668, (int) (300 * player.health / player.maxHealth), 30);
    }
    ...
    private void paintAmmoOrAmount(Graphics2D g2d) {
        ...
        String text = switch (weaponName) {
            case "Gatling" -> "" + player.weaponInventory.gatling.mag;
            case "Sniper" -> "" + player.weaponInventory.sniper.mag;
            case "Grenade launcher" -> "" + player.weaponInventory.grenadeLauncher.mag;
            case "Rocket launcher" -> "" + player.weaponInventory.rocketLauncher.mag;
            case "Missile launcher" -> "" + player.weaponInventory.missileLauncher.mag;
            case "Railgun" -> "" + player.weaponInventory.railgun.mag;
            default -> "";
        };
